# News Scrapper guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `news_scrapper/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `news_scrapper` folder and use the modules inside your notebooks :
...
```python
from news_scrapper.utils.paths import data_dir
data_dir()
```
